        ...
        <Channels>
          ...
          <MenuScroll>
            <Menu show={showWorkspaceModal} onCloseModal={toggleWorkspaceModal} style={{ top: 95, left: 80 }}>
              <WorkspaceModal>
                <h2>Sleact</h2>
                <button onClick={onClickInviteWorkspace}>invite</button>
                <button onClick={onClickAddChannel}>new Channel</button>
      ...
      <Modal show={showCreateWorkspaceModal} onCloseModal={onCloseModal}>
        <form onSubmit={onCreateWorkspace}>
          <Label id="workspace-label">
            <span>name</span>
            <Input id="workspace-name" type="text" value={newWorkspace} onChange={onChangeNewWorkspace}></Input>
          </Label>
